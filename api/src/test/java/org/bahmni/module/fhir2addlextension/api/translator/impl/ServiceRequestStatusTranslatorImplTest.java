...
public class ServiceRequestStatusTranslatorImplTest {
    ...
    /**
     * order: urgency routine, action new, date of activation = yesterday, expiry date undefined, fulfiller status = received
     * order action and urgency do not matter in this case
     */
    @Test
    ...
    /**
     * order: urgency routine, action new, date of activation = yesterday, expiry date undefined, fulfiller status = in-progress
     */
    @Test
    ...
    /**
     * order: urgency routine, action new, date of activation = yesterday, expiry date undefined, fulfiller status = completed
     */
    @Test
    ...
    /**
     * order: urgency routine, action new, date of activation = yesterday, expiry date undefined, fulfiller status = exception
     * In this case, since the order is not stopped (Date stopped is null), the order status is unknown.
     */
    @Test
    ...
    /**
     * order: urgency routine, action new, date of activation = yesterday, stop date defined, fulfiller status = exception
     */
    @Test
    public void shouldValidateOrderStatusAsRevokedWhenFulfillerStatusIsExceptionWithDateStopped() throws NoSuchFieldException, IllegalAccessException {
        Order order = new Order();
        order.setUrgency(Order.Urgency.ROUTINE);
        order.setFulfillerStatus(Order.FulfillerStatus.EXCEPTION);
        order.setAction(Order.Action.NEW);
     ...
     */
    @Test
    public void shouldValidateOrderStatusAsRevokedWhenDateOfActivationIsYesterdayAndStopDateIsSet() throws NoSuchFieldException, IllegalAccessException {
        Order order = new Order();
        order.setUrgency(Order.Urgency.ROUTINE);
        order.setAction(Order.Action.NEW);
        Date currentDate = new Date();
    ...
    /**
     * order: urgency routine, action discontinue, date of activation = yesterday, date stopped is yesterday
     * the serviceRequest is the discontinuation order, this order is active.
     * the serviceRequest.replaces is the original order, which is revoked
     * @throws NoSuchFieldException
     * @throws IllegalAccessException
     */
    @Test
    public void shouldValidateOrderStatusAsCompletedForOrderActionDiscontinue() throws NoSuchFieldException, IllegalAccessException {
        Order order = new Order();
        order.setUrgency(Order.Urgency.ROUTINE);
     ...
     * order.action - REVISE, RENEW is not applicable for Service orders like Lab,Radiology or Procedure.
     * It is expected/assumed for service requests like above, there is no revision or renewal like Medication Requests
     * @throws NoSuchFieldException
     * @throws IllegalAccessException
     */
    @Test
    public void shouldValidateOrderStatusAsUnknownForOrderActionNotNewOrDiscontinue() throws NoSuchFieldException, IllegalAccessException {
        Order order = new Order();
        order.setUrgency(Order.Urgency.ROUTINE);
    ...
    /**
     * order: urgency ON_SCHEDULED_DATE, action new, date of activation = yesterday, expiry date in future
     */
    @Test
