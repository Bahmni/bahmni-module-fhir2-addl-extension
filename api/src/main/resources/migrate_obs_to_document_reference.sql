...
SELECT
    ...
    'CURRENT',
    o.concept_id,
    CASE WHEN o.voided = 1 THEN 'ENTERED_IN_ERROR' ELSE 'FINAL' END,
    MAX(om.obs_datetime),
    MIN(ep.provider_id),
    SUBSTRING(COALESCE((SELECT om2.comments FROM obs om2 WHERE om2.obs_group_id = o.obs_id AND om2.comments IS NOT NULL ORDER BY om2.obs_id ASC LIMIT 1), ''), 1, 255),
    o.encounter_id,
    p.patient_id,
    o.creator,
    MAX(om.date_created),
