...
public class BahmniEpisodeOfCareSearchParams extends BaseResourceSearchParams {
	...
	@Builder
	public BahmniEpisodeOfCareSearchParams(ReferenceAndListParam patientReference, TokenAndListParam id,
	    DateRangeParam lastUpdated, HashSet<Include> revIncludes, SortSpec sort) {
		super(id, lastUpdated, sort, Collections.emptySet(), revIncludes);
