	...
	private ServiceRequest.ServiceRequestStatus determineServiceRequestStatus(Order order) {
		...
		if (fulfillerStatus != null) {
			switch (fulfillerStatus) {
				...
				case EXCEPTION:
					return order.getDateStopped() != null ? ServiceRequest.ServiceRequestStatus.REVOKED
					        : ServiceRequest.ServiceRequestStatus.UNKNOWN;
				default:
					break;
			}
		}
		...
		return comparisonResult < 0 ? ServiceRequest.ServiceRequestStatus.COMPLETED
