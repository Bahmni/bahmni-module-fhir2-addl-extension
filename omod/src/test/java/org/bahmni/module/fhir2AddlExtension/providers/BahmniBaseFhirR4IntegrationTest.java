...
/**
 *  Modified by Thoughtworks on 2025-03-20
 *  Modifications:
 *  - The contents of this file are copied from https://github.com/openmrs/openmrs-module-fhir2/blob/master/integration-tests/src/test/java/org/openmrs/module/fhir2/providers/r4/BaseFhirR4IntegrationTest.java
...
public abstract class BahmniBaseFhirR4IntegrationTest<T extends IResourceProvider, U extends IAnyResource> extends BahmniBaseFhirIntegrationTest<T, U> {
	...
	public U removeNarrativeAndContained(U item) {
		if (item instanceof Resource) {
			Resource copy = ((Resource) item).copy();
			if (copy instanceof DomainResource) {
				((DomainResource) copy).setText(null);
				((DomainResource) copy).setContained(null);
			}
			return (U) copy;
		}
		return item;
